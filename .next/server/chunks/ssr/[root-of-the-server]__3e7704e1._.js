...
/** @deprecated Demo mode removed — always false */ __turbopack_context__.s({
...
const YOWAUTH_BASE_URL = process.env.NEXT_PUBLIC_YOWAUTH_BASE_URL ?? 'http://localhost:8090';
...
function openNotificationStream(token, onNotif) {
    const tenantId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$session$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getTenantId"])() || __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DEMO_TENANT_ID"];
...
function buildHeaders(options, tenantId) {
    const tid = tenantId ?? readSession('tnt-tenant-id', DEMO_TENANT_ID);
    const aid = readSession('tnt-agency-id', DEMO_AGENCY_ID);
    const uid = readSession('tnt-user-id', DEMO_USER_ID);
    return {
...
async function upload(path, file, overrideTenantId) {
    ...
    const tid = overrideTenantId ?? readSession('tnt-tenant-id', DEMO_TENANT_ID);
    const aid = readSession('tnt-agency-id', DEMO_AGENCY_ID);
    const uid = readSession('tnt-user-id', DEMO_USER_ID);
    let res;
    try {
...
function Header() {
    ...
    const [notifs, setNotifs] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DEMO_MODE"] ? demoNotifs : []);
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            ...
                                            children: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DEMO_MODE"] ? 'Historique complet disponible dans les rapports' : 'Synchronisé avec le serveur'
                                        }, void 0, false, {
                                            fileName: "[project]/components/layout/Header.tsx",
                                            lineNumber: 275,
                                            columnNumber: 17
...
async function authPost(path, body) {
    const res = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["YOWAUTH_BASE_URL"]}${path}`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
...
const yowAuthService = {
    ...
    async signup (payload) {
        const data = await authPost('/api/auth/signup', payload);
        return mapTokens(data);
    }
};
...
const authService = {
    async signup (payload) {
        const tokens = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$yowauthService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["yowAuthService"].signup(payload);
    ...
    async login (credentials) {
        const tokens = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$yowauthService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["yowAuthService"].login(credentials.email, credentials.password);
        let session = sessionFromToken({
            ...tokens,
    ...
    async adminLogin (credentials) {
        ...
        const roles = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$jwt$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["claimRoles"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$jwt$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["parseJwtPayload"])(tokens.accessToken));
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$jwt$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["hasRole"])(roles, 'TNT_ADMIN')) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3e7704e1._.js.map