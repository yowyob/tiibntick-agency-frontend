...
async function livreurFetch(path, options = {}) {
    ...
    let res;
    try {
        res = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["API_BASE_URL"]}${normalized}`, {
            ...options,
            headers: {
                ...getLivreurHeaders(),
                ...options.headers
...
function LivreurLoginPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            toastError((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$errors$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["formatUserError"])(err, 'Connexion impossible. Vérifiez votre numéro et votre mot de passe.'));
        } finally{
            setLoading(false);
        }
    };
...
//# sourceMappingURL=_0ca07c6c._.js.map