...
function ProfilePage() {
    ...
    const { data: dashboard } = useService({
    ...
    const { data: branches } = useService({
    ...
    const { data: deliverers } = useService({
    ...
    const { data: vehicles } = useService({
...
_s(ProfilePage, "EBlPJGEw+tmjb6IE+7UYT8Zjtxc=", true);
_c2 = ProfilePage;
var _c, _c1, _c2;
...
//# sourceMappingURL=_1accad09._.js.map