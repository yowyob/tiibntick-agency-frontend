...
const YOWAUTH_BASE_URL = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_YOWAUTH_BASE_URL ?? 'http://localhost:8090';
...
function getAgencyId() {
    ...
    return localStorage.getItem('tnt-agency-id') ?? __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEMO_AGENCY_ID"];
}
function getTenantId() {
    if ("TURBOPACK compile-time falsy", 0) {
        "TURBOPACK unreachable";
    }
    return localStorage.getItem('tnt-tenant-id') ?? __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEMO_TENANT_ID"];
}
...
function ensureWebSocket() {
    if (__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEMO_MODE"] || "object" === 'undefined') return null;
    if (sharedSocket && sharedSocket.readyState <= WebSocket.OPEN) return sharedSocket;
    const tenantId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$session$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getTenantId"])() || __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEMO_TENANT_ID"];
...
function openTrackingStream(code, onUpdate) {
    if (__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEMO_MODE"] || "object" === 'undefined') return null;
    const url = `${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_BASE_URL"]}/tracking/${encodeURIComponent(code.trim().toUpperCase())}/stream?tenantId=${encodeURIComponent(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEMO_TENANT_ID"])}`;
    const es = new EventSource(url, {
        withCredentials: false
    });
    // EventSource ne permet pas X-Tenant-Id — le backend dev accepte le tenant par défaut sur tracking public
    es.onmessage = (e)=>{
        try {
...
function Header() {
    ...
    const [notifs, setNotifs] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEMO_MODE"] ? demoNotifs : []);
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            ...
                                            children: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEMO_MODE"] ? 'Historique complet disponible dans les rapports' : 'Synchronisé avec le serveur'
                                        }, void 0, false, {
                                            fileName: "[project]/components/layout/Header.tsx",
                                            lineNumber: 275,
                                            columnNumber: 17
...
_s1(Header, "YkCSkfJDb8pRMyIlPrKEGv6s6U0=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePathname"],
...
const authService = {
    async signup (payload) {
        ...
        const session = mapResponse(data);
        persistSession(session);
        return session;
    },
    async login (credentials) {
        const data = await authPost('/auth/login', credentials);
        const session = mapResponse(data);
        persistSession(session);
        return session;
    },
    async adminLogin (credentials) {
        const data = await authPost('/auth/admin/login', credentials);
        const session = mapResponse(data);
        persistSession(session);
        return session;
    },
    async refreshSession () {
        ...
        const res = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_BASE_URL"]}/auth/session`, {
            headers: {
                ...
                'X-User-Id': userId,
                'X-Agency-Id': localStorage.getItem('tnt-agency-id') ?? '',
                'X-User-Email': localStorage.getItem('tnt-user-email') ?? ''
            }
        });
        ...
        if (session.accessToken) persistSession(session);
            ...
            localStorage.setItem('tnt-agency-status', session.agencyStatus);
            localStorage.setItem('tnt-agency-active', String(session.agencyActive));
            if (session.agencyId) localStorage.setItem('tnt-agency-id', session.agencyId);
        }
        return session;
    },
    logout () {
...
//# sourceMappingURL=_86ce6231._.js.map