...
function getAgencyId() {
    ...
    return localStorage.getItem('tnt-agency-id') ?? '';
}
function getTenantId() {
    if ("TURBOPACK compile-time falsy", 0) {
        "TURBOPACK unreachable";
    }
    return localStorage.getItem('tnt-tenant-id') ?? '';
}
function getUserId() {
    if ("TURBOPACK compile-time falsy", 0) {
        "TURBOPACK unreachable";
    }
    return localStorage.getItem('tnt-user-id') ?? '';
}
...
async function authPost(path, body) {
    const res = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["YOWAUTH_BASE_URL"]}${path}`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
...
const authService = {
    async signup (payload) {
        const tokens = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$yowauthService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["yowAuthService"].signup(payload);
    ...
    async login (credentials) {
        const tokens = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$yowauthService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["yowAuthService"].login(credentials.email, credentials.password);
        let session = sessionFromToken({
            ...tokens,
    ...
    async adminLogin (credentials) {
        ...
        const roles = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$jwt$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["claimRoles"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$jwt$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseJwtPayload"])(tokens.accessToken));
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$jwt$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["hasRole"])(roles, 'TNT_ADMIN')) {
...
//# sourceMappingURL=_991ae805._.js.map