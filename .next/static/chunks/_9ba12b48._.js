...
function mapDeliverer(dto) {
    const label = delivererDisplayName(dto.fullName ?? undefined);
    if (label === 'Livreur' && !dto.fullName) {
    // Pas de nom backend — libellé neutre, jamais d'UUID
    }
    return {
        id: dto.id,
        agencyId: dto.agencyId,
        ...
        fullName: dto.fullName ? label : 'Livreur sans nom',
        phone: dto.phone ?? '',
        email: dto.email ?? '',
...
//# sourceMappingURL=_9ba12b48._.js.map