...
function LoginPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        setLoading(true);
        try {
            const session = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$authService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authService"].login({
                email: form.email,
                password: form.password
            });
            window.location.href = session.agencyActive ? '/' : '/pending';
        } catch (err) {
...
//# sourceMappingURL=_9ea3e1c1._.js.map