...
"[project]/lib/services/livreurAuthService.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
__turbopack_context__.s({
    ...
    "livreurMissionService": (()=>livreurMissionService)
});
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$errors$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/errors.ts [app-client] (ecmascript)");
...
;
;
const DEMO_PASSWORD = 'livreur1234';
const DEMO_TOKEN = 'demo-livreur-jwt';
function saveSession(s) {
    localStorage.setItem('tnt-livreur-token', s.token);
    localStorage.setItem('tnt-livreur-id', s.delivererId);
    localStorage.setItem('tnt-livreur-name', s.delivererName);
    localStorage.setItem('tnt-livreur-tenant-id', s.tenantId);
    localStorage.setItem('tnt-livreur-agency-id', s.agencyId);
}
function clearSession() {
    localStorage.removeItem('tnt-livreur-token');
    localStorage.removeItem('tnt-livreur-id');
    localStorage.removeItem('tnt-livreur-name');
    localStorage.removeItem('tnt-livreur-tenant-id');
    localStorage.removeItem('tnt-livreur-agency-id');
}
function getLivreurHeaders() {
    const token = ("TURBOPACK compile-time truthy", 1) ? localStorage.getItem('tnt-livreur-token') ?? '' : ("TURBOPACK unreachable", undefined);
    const tenantId = ("TURBOPACK compile-time truthy", 1) ? localStorage.getItem('tnt-livreur-tenant-id') ?? __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEMO_TENANT_ID"] : ("TURBOPACK unreachable", undefined);
    const agencyId = ("TURBOPACK compile-time truthy", 1) ? localStorage.getItem('tnt-livreur-agency-id') ?? __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEMO_AGENCY_ID"] : ("TURBOPACK unreachable", undefined);
    return {
...
async function livreurFetch(path, options = {}) {
    const normalized = path.startsWith('/') ? path : `/${path}`;
    let res;
    try {
        res = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_BASE_URL"]}${normalized}`, {
            ...options,
            headers: {
                ...getLivreurHeaders(),
                ...options.headers
        ...
        throw new Error((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$errors$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatUserError"])(null, 'Impossible de joindre le serveur. Vérifiez votre connexion.'));
    }
    if (!res.ok) {
...
const livreurAuthService = {
    async login (phone, password) {
        if (__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEMO_MODE"]) {
            ...
            const deliverer = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockDeliverers"].find((d)=>d.phone === phone);
            if (!deliverer || password !== DEMO_PASSWORD) {
            ...
            const session = {
                ...
                tenantId: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEMO_TENANT_ID"],
        ...
        const data = await livreurFetch('/auth/livreur/login', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'X-Tenant-Id': __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEMO_TENANT_ID"]
            },
            body: JSON.stringify({
                phone,
                password,
    ...
    isAuthenticated () {
        return !!localStorage.getItem('tnt-livreur-token');
    },
    getCurrentDelivererId () {
        return localStorage.getItem('tnt-livreur-id');
    },
    getCurrentDelivererName () {
        return localStorage.getItem('tnt-livreur-name');
    }
};
const livreurMissionService = {
    async getMyMissions (delivererId) {
        if (__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEMO_MODE"]) return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockMissions"].filter((m)=>m.delivererId === delivererId);
        const dtos = await livreurFetch(`/deliverers/${delivererId}/missions`);
    ...
    async getMission (missionId) {
        if (__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEMO_MODE"]) {
            const m = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockMissions"].find((x)=>x.id === missionId);
            if (!m) throw new Error('Mission introuvable');
            return m;
        }
        const dto = await livreurFetch(`/missions/${missionId}`);
    ...
    async getMyProfile (delivererId) {
        if (__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEMO_MODE"]) {
            const d = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockDeliverers"].find((x)=>x.id === delivererId);
            if (!d) throw new Error('Profil introuvable');
            return d;
        }
        const dto = await livreurFetch(`/deliverers/${delivererId}`);
    ...
    async confirmDelivery (missionId) {
        if (__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEMO_MODE"]) return;
        const delivererId = livreurAuthService.getCurrentDelivererId();
        if (!delivererId) throw new Error('Session expirée');
        await livreurFetch(`/missions/${missionId}/deliver`, {
            ...
            body: JSON.stringify({
                delivererId,
                proofReference: `POD-${Date.now()}`
            })
        });
    },
    async reportIssue (missionId, reason) {
        if (__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEMO_MODE"]) return;
        const delivererId = livreurAuthService.getCurrentDelivererId();
        if (!delivererId) throw new Error('Session expirée');
...
"[project]/app/livreur/login/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname, k: __turbopack_refresh__, m: module } = __turbopack_context__;
{
__turbopack_context__.s({
    "default": (()=>LivreurLoginPage)
});
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$livreurAuthService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/services/livreurAuthService.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$errors$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/errors.ts [app-client] (ecmascript)");
...
;
;
function LivreurLoginPage() {
    _s();
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"])();
    const { error: toastError } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$contexts$2f$ToastContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"])();
    ...
    const handleSubmit = async (e)=>{
        ...
        setLoading(true);
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$livreurAuthService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["livreurAuthService"].login(phone.trim(), password);
            router.replace('/livreur');
        } catch (err) {
            toastError((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$errors$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatUserError"])(err, 'Connexion impossible. Vérifiez votre numéro et votre mot de passe.'));
        } finally{
            setLoading(false);
        }
    };
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "flex flex-col min-h-screen bg-orange-500",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "px-6 pt-14 pb-20 flex-shrink-0",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$package$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Package$3e$__["Package"], {
                                    ...
                                    fileName: "[project]/app/livreur/login/page.tsx",
                                    lineNumber: 41,
                                    columnNumber: 13
                                }, this)
                            }, void 0, false, {
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        className: "text-[10px] font-semibold text-white/60 tracking-widest uppercase",
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        ...
                        children: "Accédez à vos missions et votre tableau de bord."
                    }, void 0, false, {
                        fileName: "[project]/app/livreur/login/page.tsx",
                        lineNumber: 53,
                        columnNumber: 9
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "flex-1 bg-white rounded-t-3xl -mt-6 px-6 pt-8 pb-10",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
                        ...
                        children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                                ...
                                                autoComplete: "tel",
                                                className: "w-full h-13 pl-11 pr-4 py-3.5 text-sm bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-400 focus:border-transparent focus:bg-white transition-colors",
                                                required: true
                                            }, void 0, false, {
                                                fileName: "[project]/app/livreur/login/page.tsx",
                                                lineNumber: 69,
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                                ...
                                                className: "w-full h-13 pl-11 pr-12 py-3.5 text-sm bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-400 focus:border-transparent focus:bg-white transition-colors",
                                                required: true
                                            }, void 0, false, {
                                                fileName: "[project]/app/livreur/login/page.tsx",
                                                lineNumber: 88,
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                ...
                                className: "w-full h-13 py-3.5 bg-orange-500 hover:bg-orange-600 active:bg-orange-700 disabled:bg-orange-200 text-white text-sm font-bold rounded-xl transition-colors flex items-center justify-center mt-2 shadow-sm shadow-orange-200",
                    ...
                    !__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEMO_MODE"] && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "mt-8 rounded-2xl border border-gray-200 bg-gray-50 p-4",
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                className: "text-[11px] font-bold text-gray-600 uppercase tracking-wider mb-2",
                                children: "Mode live"
                            }, void 0, false, {
                                fileName: "[project]/app/livreur/login/page.tsx",
                                lineNumber: 124,
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                ...
                                children: [
                                    "Connectez-vous avec votre numéro de téléphone enregistré par l'agence (onglet Personnel → Livreurs). Mot de passe : ",
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        className: "font-semibold",
                                        children: "livreur1234"
                                    }, void 0, false, {
                                        fileName: "[project]/app/livreur/login/page.tsx",
                                        lineNumber: 128,
                                        columnNumber: 30
                    ...
                    __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEMO_MODE"] && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "mt-8 rounded-2xl border border-orange-100 bg-orange-50 p-4",
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                className: "text-[11px] font-bold text-orange-600 uppercase tracking-wider mb-3",
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(DemoAccount, {
                                        label: "Disponible",
                                        phone: "+237 691 23 45 67",
                                        name: "Jean-Paul Essomba",
                                        onFill: ()=>{
                                            setPhone('+237 691 23 45 67');
                                            setPassword('livreur1234');
                                        }
                                    }, void 0, false, {
                                        fileName: "[project]/app/livreur/login/page.tsx",
                                        lineNumber: 136,
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                className: "text-[11px] text-orange-500 mt-3",
                                children: [
                                    "Mot de passe : ",
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
...
_s(LivreurLoginPage, "8Iaooy6umAos0dPNT/50ItjUDIE=", false, function() {
    return [
...
_c = LivreurLoginPage;
function DemoAccount({ label, phone, name, onFill }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
        type: "button",
        onClick: onFill,
        className: "w-full flex items-center justify-between bg-white rounded-xl px-3 py-2.5 border border-orange-100 hover:border-orange-300 transition-colors text-left",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                className: "text-[10px] font-semibold text-orange-500 bg-orange-50 px-2 py-0.5 rounded-full",
                children: label
            }, void 0, false, {
                fileName: "[project]/app/livreur/login/page.tsx",
                lineNumber: 170,
...
_c1 = DemoAccount;
var _c, _c1;
__turbopack_context__.k.register(_c, "LivreurLoginPage");
__turbopack_context__.k.register(_c1, "DemoAccount");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=_b07d7aba._.js.map