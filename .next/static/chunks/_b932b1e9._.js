...
async function request(path, options = {}, overrideTenantId) {
    ...
    const res = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_BASE_URL"]}${normalizedPath}`, {
        ...options,
...
function mapDeliverer(dto) {
    const label = dto.fullName ?? `Livreur ${(dto.actorId ?? dto.id).slice(0, 8)}`;
    return {
        id: dto.id,
        agencyId: dto.agencyId,
...
function mapMission(dto) {
    return {
        ...
        branchId: dto.branchId ?? '',
        branchName: dto.branchName ?? '',
        manifestNumber: dto.manifestNumber ?? dto.id.slice(0, 8).toUpperCase(),
...
function mapFreelancer(dto) {
    ...
    return {
        ...
        freelancerName: dto.freelancerName ?? `Freelancer ${dto.freelancerActorId.slice(0, 8)}`,
        phone: dto.phone ?? '',
        commissionRate: rate,
...
;
const branchService = {
    async getBranches (agencyId = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEMO_AGENCY_ID"]) {
        ...
        const dtos = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].get(`/agencies/${agencyId}/branches`);
...
const staffService = {
    async getStaffMembers (agencyId = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEMO_AGENCY_ID"]) {
        if (__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEMO_MODE"] || __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["STAFF_ADMIN_DEMO"]) return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockStaffMembers"];
        return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].get(`/agencies/${agencyId}/staff`);
    },
    async registerStaffMember (agencyId, data) {
        if (__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEMO_MODE"] || __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["STAFF_ADMIN_DEMO"]) {
...
;
const fleetService = {
    async getVehicles (agencyId = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEMO_AGENCY_ID"]) {
        ...
        const dtos = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].get(`/agencies/${agencyId}/vehicles`);
...
;
const hubService = {
    async getHubs (agencyId = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEMO_AGENCY_ID"]) {
        ...
        const dtos = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].get(`/agencies/${agencyId}/hubs`);
    ...
    async getAllParcelRecords (agencyId = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEMO_AGENCY_ID"]) {
...
const missionService = {
    async getMissions (agencyId = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEMO_AGENCY_ID"]) {
        ...
        const dtos = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].get(`/agencies/${agencyId}/missions`);
...
function useAgencyLookups(agencyId = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEMO_AGENCY_ID"]) {
    _s();
    ...
    const refetch = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useAgencyLookups.useCallback[refetch]": ()=>{
            ...
            Promise.all([
                __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$branchService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["branchService"].getBranches(agencyId),
                __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$staffService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["staffService"].getDeliverers(agencyId),
                __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$fleetService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fleetService"].getVehicles(agencyId),
                __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$hubService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["hubService"].getHubs(agencyId),
                __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$staffService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["staffService"].getStaffMembers(agencyId),
                __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$missionService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["missionService"].getMissions(agencyId)
            ]).then({
...
function delivererLabel(deliverers, id) {
    if (!id) return '—';
    return deliverers.find((d)=>d.id === id)?.fullName ?? id.slice(0, 8);
}
...
function CreateMissionForm({ open, onClose, onSuccess }) {
    ...
    const handleSubmit = async (e)=>{
        ...
        setSubmitting(true);
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$missionService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["missionService"].createMission(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEMO_AGENCY_ID"], {
...
function demoDashboard(agencyId) {
    const active = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockMissions"].filter((m)=>[
            'PENDING',
            'ASSIGNED',
            'IN_TRANSIT'
        ].includes(m.status)).length;
    const pendingComm = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockCommissions"].filter((c)=>c.status === 'CALCULATED').length;
    return {
        agencyId,
        branchesCount: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockBranches"].length,
        deliverersCount: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockDeliverers"].length,
        hubsCount: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockHubs"].length,
        vehiclesCount: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockVehicles"].length,
        activeMissionsCount: active,
        pendingCommissionsCount: pendingComm
    };
}
const analyticsService = {
    async getDashboard (agencyId = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEMO_AGENCY_ID"]) {
        if (__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEMO_MODE"]) return demoDashboard(agencyId);
        return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].get(`/agencies/${agencyId}/dashboard`);
    },
    async getReports (agencyId = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEMO_AGENCY_ID"]) {
        if (__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEMO_MODE"]) {
            const missionsByStatus = {};
            for (const m of __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockMissions"]){
                missionsByStatus[m.status] = (missionsByStatus[m.status] ?? 0) + 1;
            }
            const commissionsByStatus = {};
            for (const c of __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockCommissions"]){
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].get(`/agencies/${agencyId}/reports`);
    }
};
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
...
;
;
const dashboardFallback = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$emptyDefaults$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EMPTY_DASHBOARD"];
const reportsFallback = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$emptyDefaults$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EMPTY_REPORT"];
// ── Stat card ──────────────────────────────────────────────
...
function DashboardPage() {
    ...
    const { data: dashboard } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$hooks$2f$useService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useService"])({
        "DashboardPage.useService": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$analyticsService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["analyticsService"].getDashboard()
    }["DashboardPage.useService"], dashboardFallback);
    const { data: reports } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$hooks$2f$useService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useService"])({
        "DashboardPage.useService": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$analyticsService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["analyticsService"].getReports()
    }["DashboardPage.useService"], reportsFallback);
    const { data: missions } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$hooks$2f$useService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useService"])({
        "DashboardPage.useService": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$missionService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["missionService"].getMissions()
    }["DashboardPage.useService"], __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$emptyDefaults$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EMPTY_MISSIONS"]);
    const { data: deliverers } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$hooks$2f$useService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useService"])({
        "DashboardPage.useService": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$staffService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["staffService"].getDeliverers()
    }["DashboardPage.useService"], __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$emptyDefaults$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EMPTY_DELIVERERS"]);
    const { data: vehicles } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$hooks$2f$useService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useService"])({
        "DashboardPage.useService": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$fleetService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fleetService"].getVehicles()
    }["DashboardPage.useService"], __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$emptyDefaults$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EMPTY_VEHICLES"]);
    const { data: hubs } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$hooks$2f$useService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useService"])({
        "DashboardPage.useService": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$hubService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["hubService"].getHubs()
    }["DashboardPage.useService"], __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$emptyDefaults$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EMPTY_HUBS"]);
    ...
    const localCounts = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$missionService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["missionService"].getStatusCounts(missions);
...
_s(DashboardPage, "DM/zf40pGxjc+rwuaF4eyINjmGA=", false, function() {
    return [
...
__turbopack_context__.k.register(_c2, "PriorityDot");
...
//# sourceMappingURL=_b932b1e9._.js.map