  ...
  return (
    <div className="p-8 max-w-4xl">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-semibold text-gray-900">QR codes du hub</h1>
      ...
      <div className="grid sm:grid-cols-2 gap-6">
        <div className="bg-white border border-gray-200 rounded-xl p-6 text-center print:break-inside-avoid">
          <p className="text-xs font-semibold uppercase tracking-wider text-emerald-700 mb-2">QR Dépôt</p>
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-6 text-center print:break-inside-avoid">
          <p className="text-xs font-semibold uppercase tracking-wider text-blue-700 mb-2">QR Retrait</p>
